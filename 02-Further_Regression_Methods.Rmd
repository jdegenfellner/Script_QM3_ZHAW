...
The higher the `AGE` (which is standardized), the higher the probability of a *Yes* (or $1$) 
...
Another nice feature in R is to visualize the predicted probabilities with a confidence band:
...
- no perfect separation: This means that there should not be a cutoff under 
