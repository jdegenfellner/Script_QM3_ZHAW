...
#### Linearity of the log of $\lambda$ 

The following plot should not be perfectly linear if we do not artificially create the data.
We have defined the linear relationship explicitely, hence the plot is perfectly linear ($log(\lambda) = 0.5x-2$).
