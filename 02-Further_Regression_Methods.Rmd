...
since our outcome is binary (*survived*/*died*).
...
The **amount of regularization is controlled by the hyperparameter** $\sigma$ and is 
...
**It is always a good idea to know your raw data.**
...
- There seem to be no **influential observations**, which have simultaneously a large 
...
i.e., we explicitly modeled **heteroscedasticity**.
...
### Model Assumptions 
(Maybe this [link](https://cambiotraining.github.io/stats-glm/materials/glm-11-checking-assumptions.html) 
is interesting. Further reading on checking the assumptions of count models:
[Roback & Legler, *Beyond Multiple Linear Regression*, Ch. 4](https://bookdown.org/roback/bookdown-BeyondMLR/ch-poissonreg.html#poisson-regression-assumptions),
the [`DHARMa` vignette](https://cran.r-project.org/web/packages/DHARMa/vignettes/DHARMa.html)
on residual diagnostics via simulated residuals, and
[overdispersed count data](https://cambiotraining.github.io/stats-glm/materials/glm-13-overdispersed-count-data.html).)
...
- [Compositional data](https://en.wikipedia.org/wiki/Compositional_data)
  ...
  Here is a [simple example](https://www.geo.fu-berlin.de/en/v/soga-r/Advanced-statistics/Feature-scales/Intro_compositional_data/index.html).
...
There are also **unknown unknowns**, which not even cutting edge researchers are aware of.
Previously, dealing with *compositional data* was such a problem.
