...
## Chain 4 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpeOPBcv/model-14069738e93eb.stan', line 15, column 4 to column 32)
...
\begin{verbatim}
## Chain 1 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpeOPBcv/model-140691d1fe517.stan', line 29, column 4 to column 31)
\end{verbatim}
...
a \(1\)} (\$ = p\_i = \mathbb{E}(Y\_i)\$ if \(Y_i\) is Bernoulli
distributed). Of course, then we have the next problem, if we try to
model the probability of a \(1\) \emph{directly} using the linear
regression model
...
\pandocbounded{\includegraphics[keepaspectratio]{02-Further_Regression_Methods_files/figure-latex/unnamed-chunk-25-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{02-Further_Regression_Methods_files/figure-latex/unnamed-chunk-30-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{02-Further_Regression_Methods_files/figure-latex/unnamed-chunk-33-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{02-Further_Regression_Methods_files/figure-latex/unnamed-chunk-35-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{02-Further_Regression_Methods_files/figure-latex/unnamed-chunk-38-1.pdf}}
