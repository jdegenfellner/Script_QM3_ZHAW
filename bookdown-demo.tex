...
\section{Separate PDFs of this script (might not be up to date)}\label{separate-pdfs-of-this-script-might-not-be-up-to-date}
...
\item
  \href{https://github.com/jdegenfellner/Script_QM3_ZHAW/blob/main/02-Further_Regression_Methods.pdf}{Chapter Further Regression Methods}
\end{itemize}
...
\begin{verbatim}
## Chain 3 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpWGmIgr/model-aaab44254a1d.stan', line 17, column 4 to column 34)
\end{verbatim}
...
\begin{verbatim}
## Chain 4 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpWGmIgr/model-aaab44254a1d.stan', line 17, column 4 to column 34)
\end{verbatim}
...
\begin{verbatim}
## Chain 5 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpWGmIgr/model-aaab44254a1d.stan', line 17, column 4 to column 34)
\end{verbatim}
...
\begin{verbatim}
## Chain 6 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpWGmIgr/model-aaab44254a1d.stan', line 17, column 4 to column 34)
\end{verbatim}
...
\begin{verbatim}
## Chain 7 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpWGmIgr/model-aaab44254a1d.stan', line 17, column 4 to column 34)
\end{verbatim}
...
\begin{verbatim}
## Chain 8 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpWGmIgr/model-aaab44254a1d.stan', line 17, column 4 to column 34)
\end{verbatim}
...
\begin{verbatim}
## Chain 3 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
## Chain 3 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpWGmIgr/model-aaab6d3d4760.stan', line 21, column 4 to column 45)
## Chain 3 If this warning occurs sporadically, such as for highly constrained variable types like covariance matrices, then the sampler is fine,
## Chain 3 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
## Chain 3
\end{verbatim}
...
\begin{verbatim}
## Chain 8 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
## Chain 8 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpWGmIgr/model-aaab6d3d4760.stan', line 21, column 4 to column 45)
## Chain 8 If this warning occurs sporadically, such as for highly constrained variable types like covariance matrices, then the sampler is fine,
## Chain 8 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
## Chain 8
\end{verbatim}
...
\subsubsection{Model 13.1. Partial pooling using regularizing priors}\label{model13_1}
...
but know they \emph{know} from each other via the prior for \(\bar{\alpha}\).
...
\begin{verbatim}
## Chain 4 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
## Chain 4 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpWGmIgr/model-aaab20a93b62.stan', line 15, column 4 to column 32)
## Chain 4 If this warning occurs sporadically, such as for highly constrained variable types like covariance matrices, then the sampler is fine,
## Chain 4 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
## Chain 4
\end{verbatim}
...
\textbf{It is alway a good idea to know your raw data.}
...
If you want to see the \textbf{random effects} of all \(91\) participants explicitely:
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-33-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-33-2.pdf}}
...
\begin{verbatim}
## Chain 1 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpWGmIgr/model-aaab59e86ffc.stan', line 29, column 4 to column 31)
\end{verbatim}
...
The higher the \texttt{AGE}, the higher the probability of a 1 (heart attaack or something).
...
\begin{itemize}
\item
  \texttt{glm}stands for \href{https://en.wikipedia.org/wiki/Generalized_linear_model}{\emph{generalized linear model}}.
\item
...
\end{verbatim}
\item
  \texttt{Residual\ deviance} is the deviance of the model with the predictors.
...
\item
  There seem to be no \textbf{influential obervations}, which have simultaneously a large
...
i.e., we explicitely modeled \textbf{heteroscedasticity}.
...
\item
  \href{https://en.wikipedia.org/wiki/Compositional_data}{Compostional data}
...
There are also \textbf{unknown unknowns}, which not even cutting edge reasarchers are aware of.
Previously, dealing with \emph{compositional data} data was such a problem.
...
\pandocbounded{\includegraphics[keepaspectratio]{images/GPT_4_image_description.png}}
...
\section{Capabilites of LLMs}\label{capabilites-of-llms}
...
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio]{images/GPT4_me.png}}
\item
